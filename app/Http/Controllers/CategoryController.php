    ...
    function getUser()
    {
        ...
        ->addColumn('status', function($rows){
            ...
            ->addColumn('action', function ($data) {
                $updateButton = '<a href="#" id="' . $data->id . '" class="btn btn-outline-success btn-sm editIcon" data-bs-toggle="modal" data-bs-target="#editEmployeeModal"><i class="bi-pencil-square h4"></i></a>';
